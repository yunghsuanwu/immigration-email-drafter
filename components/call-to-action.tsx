export function CallToAction() {
  return (
    <section id="call-to-action" className="py-6 md:py-10 text-center px-4 mb-8">
      ...
      <p className="text-muted-foreground max-w-2xl mx-auto mt-4">
        The immigration rule change is subject to your MP&apos;s approval via voting. Make your voice heard by telling them your story and showing them the impact of the changes.
      </p>
