export function RuleChange() {
  return (
    <section id="immigration-rule-change" className="max-w-2xl mx-auto py-8 md:py-12 px-4 mb-12 text-left">
      <div>
        <h1 className="text-3xl font-bold mb-10 text-center">2025 Immigration Rule Change: A Summary</h1>
        <div className="max-w-2xl w-full text-left mx-auto bg-white rounded-lg shadow p-6">
          ...
          <ul className="list-disc list-outside space-y-2 mb-4 ml-4 pl-4">
            <li>The skill threshold for Skilled Worker visas is now raised, and 111 eligible occupations are now removed;</li>
