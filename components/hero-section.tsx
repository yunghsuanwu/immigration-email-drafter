...
export function HeroSection() {
  ...
  return (
    <section className="py-12 md:py-32 text-left md:text-center px-4 mb-12">
      <div className="max-w-3xl mx-auto flex flex-col gap-8 items-start md:items-center">
        ...
        <span className="block text-xl md:text-2xl font-medium text-muted-foreground tracking-tight mb-2">
          Without debate, without consultation, new immigration rules are coming to the UK Parliament on 22 July 2025.
        </span>
        <button
          type="button"
